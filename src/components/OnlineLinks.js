...
class OnlineLinks extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      onlineclasses: [{ ord: 1, instructor: "Kayleigh", meetingid: "851 1656 6456", passcode: "ballet", zoomlink: "https://us02web.zoom.us/j/85116566456?pwd=QTNVL05LbWlzMEE2UytmYlFkZWptUT09" }],
    };
  }
